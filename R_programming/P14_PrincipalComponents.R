...
plot(pc)  # A scree plot shows the proportion of variance explained by each principal component. 
biplot(pc)  # A biplot displays both the principal component scores and the loadings. 
